...
import static com.hubspot.sendinvitaions.api.utils.ApiConstants.DATE_FORMAT;
import static com.hubspot.sendinvitaions.api.utils.ApiConstants.DIFF_IN_DAYS;
...
public class ApiHelper {
	...
	/**
	 * Check available dates and get invitations.
	 *
	...
	/**
	 * Generate invitation request obj.
	 *
	 * @param countryToDateMap    the country to date map
	 * @param partnersList        the partners list
	 * @param countriesToIndexMap the countries to index map
	 * @return the list
	 */
